...
namespace BaLogisticsSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ...
            //ViewBag.UserName = _userService.GetSingle(User.Identity.Name);
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (var db = new BaLogisticsSystemContext())
                {
                    ...
                    if (user == null)
                    {
                        ...
                        db.UserProfiles.Add(new UserProfileEntity { UserName = model.UserName });
                        db.SaveChanges();
